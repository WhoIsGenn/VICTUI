...
local ConfigPath = "Victoria Hub/Config/" 

if not isfolder("Victoria Hub") then makefolder("Victoria Hub") end
if not isfolder("Victoria Hub/Config") then makefolder("Victoria Hub/Config") end
...
local Victoriahub = {}
function Victoriahub:MakeNotify(NotifyConfig)
...
function Victoriahub:Window(GuiConfig)
    ...
    local Victoriahubb = Instance.new("ScreenGui");
    ...
    Victoriahubb.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    Victoriahubb.Name = "Victoriahubb"
    Victoriahubb.ResetOnSpawn = false
    Victoriahubb.Parent = game:GetService("CoreGui")
    ...
    DropShadowHolder.Parent = Victoriahubb

    DropShadowHolder.Position = UDim2.new(0, (Victoriahubb.AbsoluteSize.X // 2 - DropShadowHolder.Size.X.Offset // 2), 0,
        (Victoriahubb.AbsoluteSize.Y // 2 - DropShadowHolder.Size.Y.Offset // 2))
    ...
    ThemeImage.ZIndex = 0
    ThemeImage.Image = "rbxassetid://79482005659181"
    ...
    function GuiFunc:DestroyGui()
        if CoreGui:FindFirstChild("Victoriahubb") then
            Victoriahubb:Destroy()
        end
    end
    ...
    Close.Activated:Connect(function()
        ...
        Title.Text = "Victoria Hub Window"
        Title.TextSize = 22
        ...
        Yes.MouseButton1Click:Connect(function()
            ...
            ScriptLoaded = false
            NoclipEnabled = false
            if Victoriahubb then Victoriahubb:Destroy() end
