...
local function createPingDisplay()
    ...
    -- Drag Area (invisible frame for dragging)
    local DragArea = Instance.new("Frame", Frame)
    DragArea.Size = UDim2.new(1, -60, 0, 45)
    DragArea.Position = UDim2.fromOffset(0, 0)
    DragArea.BackgroundTransparency = 1
    DragArea.ZIndex = 1004
...
local function optimizeInstance(obj)
    ...
    pcall(function()
        ...
        -- Clothing & Appearance
        if obj:IsA("Clothing") or obj:IsA("ShirtGraphic") or obj:IsA("SurfaceAppearance") then
            obj:Destroy()
        end
        ...
        -- TextLabels
        if obj:IsA("TextLabel") and obj:IsDescendantOf(workspace) then
            saveOriginal(obj, "Visible")
            obj.Visible = false
        end
