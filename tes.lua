...
-- ==================== BLATANT V3 ====================
local blatantV3Section = Tab3:AddSection("Blatant V3 (Aggressive Stable)")
...
-- ==================== AUTO TUNE ====================
local function AutoTuneCast()
    -- perfect zone tapi randomized
    local power = -1.23 + (math.random(-40,40) / 1000)
    local acc   = 0.996 + (math.random(0,5) / 1000)
    return power, acc
end
...
local function StartBlatant()
    ...
    mainThread = task.spawn(function()
        ...
        while State.Running do
            ...
            -- START MINIGAME (LOOPED, NOT 1x)
            local p,a = AutoTuneCast()
            pcall(function()
